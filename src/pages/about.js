...
export default () => (
    <Layout>
        ...
        <div>
            ...
            <p>I'm currently a software engineer at JPMorgan Chase &amp; Co. where I'm fortunate enough to both design and code. During the work day, I also lead an accessibility workshop for engineers, serve as a chair of the company sustainability group, and assist in weekly yoga classes. I'm also involved with the business resource groups for women, Asians, LGBTQ, and veterans an ally and </p>
            <img src={JPMorgan} className={styles.image} alt="Tech Connect Photo"/>
            <p>Outside of my 9-5, I'm a powerlifter and a budding yogi. I also develop content for a Youtube channel where I teach programming languages, frameworks, and tech topics like accessibility in a casual format with lots of memes. I'm a polymath who loves to learn, with my favorite subjects being medieval art history, electronics &amp; circuts, and surprisingly, math!</p>
