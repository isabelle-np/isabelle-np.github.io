    ...
    <Layout>
        <div className={styles.container}>
            ...
            <Link to='/#portfolio' className={styles.arrow}>
                <img className={styles.animation} src="https://d3n32ilufxuvd1.cloudfront.net/55c4887f2541c97e1b608fee/1341550/upload-a74f3e75-fba2-43cb-967a-63dfb6cf214c.png"/>
